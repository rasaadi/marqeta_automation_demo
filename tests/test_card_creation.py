...
class TestCardCreation(BaseTest):
    ...
    def test_create_card_without_user_token_fail(self, resources):
        ...
        #
        card_verifications = CardVerifications()
        card_verifications.verify_no_user_token_card_creation_fail(card)
    ...
    def test_create_card_with_invalid_product_token_fail(self, resources):
        ...
        # ================ VERIFICATION ================
        #
        logger.info("Card details: {}".format(card))
        card_verifications = CardVerifications()
        card_verifications.verify_invalid_product_token_card_creation_fail(
            card)
    ...
    def test_create_personalized_card_with_name_success(self, resources):
        ...
        #
        card_verifications = CardVerifications()
        card_verifications.verify_card_creation_custom_name_success(card,
                                                                    custom_name)
    ...
    def test_create_multiple_cards_same_user_product_success(self, resources):
        ...
        #
        card_verifications = CardVerifications()
        card_verifications.verify_multiple_cards_same_user_product_success(
            card1, card2)
